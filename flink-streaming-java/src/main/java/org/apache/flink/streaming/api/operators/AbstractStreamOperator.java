...
public abstract class AbstractStreamOperator<OUT>
	...
	private transient StreamOperatorStateManager streamOperatorStateManager;
	...
	public void setup(StreamTask<?, ?> containingTask, StreamConfig config, Output<StreamRecord<OUT>> output) {
		...
		this.config = config;
		this.metrics = environment.getMetricGroup().addOperator(config.getOperatorName());
		...
		streamOperatorStateManager = new StreamOperatorStateManager(
			this,
			config,
			containingTask.getEnvironment().getTaskStateManager(),
			containingTask.getStateBackend(),
			containingTask.getProcessingTimeService(),
	...
	public final void initializeState() throws Exception {
		...
		StreamOperatorStateContext stateContext = streamOperatorStateManager.streamOperatorStateContext();
