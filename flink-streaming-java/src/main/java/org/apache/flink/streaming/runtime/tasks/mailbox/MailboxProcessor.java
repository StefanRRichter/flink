...
public class MailboxProcessor {
	...
	public void runMailboxLoop() throws Exception {
		...
		while (processMail(localMailbox)) {
			mailboxDefaultAction.performDefaultAction(defaultActionContext);
		}
	}
	 ...
	 *
	 */
	private final class MailboxDefaultActionContext implements MailboxDefaultAction.DefaultActionContext {
