...
//
//	private final StreamTaskStateManager streamTaskStateManager;
//
...
//		this.streamTaskStateManager = Preconditions.checkNotNull(streamTaskStateManager);
//		this.processingTimeService = Preconditions.checkNotNull(processingTimeService);
//		this.closeableRegistry = Preconditions.checkNotNull(closeableRegistry);
//		this.env = Preconditions.checkNotNull(env);
//
//		this.operatorSubtaskStateFromJobManager = streamTaskStateManager.operatorStates(operator.getOperatorID());
//
...
//
//		// -------------- Keyed State Backend --------------
//		final AbstractKeyedStateBackend<?> keyedStatedBackend = createKeyedStatedBackend(keySerializer);
//
...
//			streamTaskStateManager.createStreamFactory(operatorIdentifierText);
//
...
//
//		return createKeyedStatedBackendFromJobManagerState(keySerializer);
//	}
//
...
//			streamTaskStateManager.createOperatorStateBackend(operatorIdentifierText);
//
...
//		TypeSerializer<K> keySerializer) throws Exception {
//
//		AbstractKeyedStateBackend<K> keyedStateBackend = streamTaskStateManager.createKeyedStateBackend(
