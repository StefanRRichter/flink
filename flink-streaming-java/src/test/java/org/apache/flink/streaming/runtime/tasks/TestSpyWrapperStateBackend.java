...
public class TestSpyWrapperStateBackend extends AbstractStateBackend {
		...
		public CheckpointStreamFactory createStreamFactory(
			...
			return spy(delegate.createStreamFactory(jobId, operatorIdentifier));
		}
		...
		public CheckpointStreamFactory createSavepointStreamFactory(
			...
			return spy(delegate.createSavepointStreamFactory(jobId, operatorIdentifier, targetLocation));
		}
	...
	public StreamStateHandle resolveCheckpoint(String pointer) throws IOException {
		return spy(delegate.resolveCheckpoint(pointer));
	}
