...
public class AsyncWaitOperatorTest extends TestLogger {
	...
	public void testStateSnapshotAndRestore() throws Exception {
		...
		TaskOperatorSubtaskStates subtaskStates = env.getCheckpointStateHandles();
	...
	private static class AcknowledgeStreamMockEnvironment extends StreamMockEnvironment {
		...
		private volatile TaskOperatorSubtaskStates checkpointStateHandles;
		...
		public void acknowledgeCheckpoint(
				...
				TaskOperatorSubtaskStates checkpointStateHandles) {
		...
		public TaskOperatorSubtaskStates getCheckpointStateHandles() {
