...
public abstract class WriteAheadSinkTestBase<IN, S extends GenericWriteAheadSink<IN>> extends TestLogger {
	...
	public void testDataDiscardingUponRestore() throws Exception {
		...
		OperatorSubtaskStateReport latestSnapshot = testHarness.snapshot(snapshotCount++, 0);
		testHarness.notifyOfCompletedCheckpoint(snapshotCount - 1);
	...
	public void testScalingDown() throws Exception {
		...
		OperatorSubtaskStateReport snapshot1 = testHarness1.snapshot(snapshotCount, 0);
		OperatorSubtaskStateReport snapshot2 = testHarness2.snapshot(snapshotCount, 0);

		// merge the two partial states
		OperatorSubtaskStateReport mergedSnapshot = AbstractStreamOperatorTestHarness
	...
	public void testScalingUp() throws Exception {
		...
		OperatorSubtaskStateReport snapshot = testHarness1.snapshot(++snapshotCount, 0);
