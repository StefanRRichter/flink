...
public class OperatorIDMappedStateToChainConverter {
	...
	public static TaskStateHandles convert(
		TaskOperatorSubtaskStates subtaskStates,
	...
	public static TaskStateHandles convert(TaskOperatorSubtaskStates subtaskStates, List<OperatorID> operatorIDsInChainOrder) {
