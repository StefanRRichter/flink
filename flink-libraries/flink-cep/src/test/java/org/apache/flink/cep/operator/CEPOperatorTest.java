...
public class CEPOperatorTest extends TestLogger {
	...
	public void testKeyedCEPOperatorCheckpointing() throws Exception {
		...
		try {
			...
			OperatorSubtaskStateReport snapshot = harness.snapshot(0L, 0L);
			harness.close();
			...
			OperatorSubtaskStateReport snapshot2 = harness.snapshot(1L, 1L);
			harness.close();
	...
	public void testKeyedCEPOperatorNFAUpdate() throws Exception {
		...
		try {
			...
			OperatorSubtaskStateReport snapshot2 = harness.snapshot(0L, 0L);
			harness.close();
