...
public class RollingSinkITCase extends StreamingMultipleProgramsTestBase {
	...
	public void testBucketStateTransitions() throws Exception {
		...
		OperatorSubtaskStateReport snapshot = testHarness.snapshot(1, 0);
	...
	public void testScalingDown() throws Exception {
		...
		OperatorSubtaskStateReport mergedSnapshot = AbstractStreamOperatorTestHarness.repackageState(
