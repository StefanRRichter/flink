...
public abstract class SnapshotDirectory {
	...
	public boolean isSnapshotCompleted() {
		return State.COMPLETED.equals(state.get());
	}
	 ...
	 * {@link #cleanup()}.
	 */
	public static SnapshotDirectory temporary(@Nonnull Path directory, @Nonnull FileSystem fileSystem) {
		return new TemporarySnapshotDirectory(directory, fileSystem);
	}
	 ...
	 */
	public static SnapshotDirectory permanent(@Nonnull Path directory, @Nonnull FileSystem fileSystem) {
		return new PermanentSnapshotDirectory(directory, fileSystem);
	}

	private static class TemporarySnapshotDirectory extends SnapshotDirectory {

		TemporarySnapshotDirectory(@Nonnull Path directory, @Nonnull FileSystem fileSystem) {
			super(directory, fileSystem);
		}
	...
	private static class PermanentSnapshotDirectory extends SnapshotDirectory {
		...
		PermanentSnapshotDirectory(@Nonnull Path directory, @Nonnull FileSystem fileSystem) {
			super(directory, fileSystem);
		}
