...
/**
 * Interface for backends that can perform snapshots of their state.
 */
public interface Snapshotable {
	 ...
	 *
	 * @param snapshot the old state to restore.
	 */
	void restore(Snapshot snapshot) throws Exception;
}
