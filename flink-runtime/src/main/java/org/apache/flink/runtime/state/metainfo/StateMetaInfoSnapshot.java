...
public class StateMetaInfoSnapshot {
	...
	public boolean equals(Object o) {
		...
		StateMetaInfoSnapshot snapshot2 = (StateMetaInfoSnapshot) o;
		StateMetaInfoSnapshot snapshot1 = (StateMetaInfoSnapshot) o;
		return Objects.equals(getName(), snapshot2.getName()) &&
			Objects.equals(options, snapshot2.options) &&
			Objects.equals(serializerConfigSnapshots, snapshot2.serializerConfigSnapshots) &&
			Objects.equals(serializers, snapshot2.serializers);
	}

	@Override
	public int hashCode() {

		return Objects.hash(getName(), options, serializerConfigSnapshots, serializers);
	}
}
