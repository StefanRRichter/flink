 ...
 * {@link TaskOperatorSubtaskStates} that are collected by the checkpoint coordinator from all tasks represent the whole
 * state of a job at the time of the checkpoint.
 */
public class TaskOperatorSubtaskStates implements CompositeStateHandle {
	...
	public TaskOperatorSubtaskStates() {
		this(new HashMap<OperatorID, OperatorSubtaskState>());
	}

	public TaskOperatorSubtaskStates(int size) {
		this(new HashMap<OperatorID, OperatorSubtaskState>(size));
	}

	public TaskOperatorSubtaskStates(Map<OperatorID, OperatorSubtaskState> subtaskStatesByOperatorID) {
	...
	public boolean equals(Object o) {
		...
		TaskOperatorSubtaskStates that = (TaskOperatorSubtaskStates) o;
