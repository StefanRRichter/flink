...
object TestingJobManagerMessages {
  ...
  /**
    ...
    */
  case class CheckpointRequest(jobId: JobID, options: CheckpointOptions) extends RequiresLeaderSessionID
  ...
  /**
    ...
    */
  case class CheckpointRequestSuccess(jobId: JobID, checkpointId: Long, path: String, triggerTime: Long)
