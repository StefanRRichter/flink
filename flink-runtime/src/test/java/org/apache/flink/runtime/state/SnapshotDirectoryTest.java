...
public class SnapshotDirectoryTest extends TestLogger {
	...
	public void mkdirs() throws Exception {
		...
		SnapshotDirectory snapshotDirectory = SnapshotDirectory.permanent(path, path.getFileSystem());
	...
	public void completeSnapshotAndGetHandle() throws Exception {
		...
		FileSystem fileSystem = folderAPath.getFileSystem();

		SnapshotDirectory snapshotDirectory = SnapshotDirectory.permanent(folderAPath, fileSystem);
		...
		Assert.assertFalse(folderA.isDirectory());
		Assert.assertTrue(folderA.mkdirs());
		snapshotDirectory = SnapshotDirectory.permanent(folderAPath, fileSystem);
		Assert.assertTrue(snapshotDirectory.cleanup());
		try {
	...
	public void isSnapshotOngoing() throws Exception {
		...
		FileSystem fileSystem = pathA.getFileSystem();
		SnapshotDirectory snapshotDirectory = SnapshotDirectory.permanent(pathA, fileSystem);
		...
		snapshotDirectory = SnapshotDirectory.permanent(pathA, fileSystem);
		Assert.assertFalse(snapshotDirectory.isSnapshotCompleted());
	...
	public void temporary() throws Exception {
		...
		SnapshotDirectory tmpSnapshotDirectory = SnapshotDirectory.temporary(folderPath, folderPath.getFileSystem());
