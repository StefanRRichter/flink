...
public class CheckpointCoordinatorTest extends TestLogger {
	...
	public void testTriggerAndConfirmSimpleCheckpoint() {
		try {
			...
			TaskOperatorSubtaskStates taskOperatorSubtaskStates1 = mock(TaskOperatorSubtaskStates.class);
			TaskOperatorSubtaskStates taskOperatorSubtaskStates2 = mock(TaskOperatorSubtaskStates.class);
	...
	public void testSuccessfulCheckpointSubsumesUnsuccessful() {
		try {
			...
			TaskOperatorSubtaskStates taskOperatorSubtaskStates1_1 = spy(new TaskOperatorSubtaskStates());
			TaskOperatorSubtaskStates taskOperatorSubtaskStates1_2 = spy(new TaskOperatorSubtaskStates());
			TaskOperatorSubtaskStates taskOperatorSubtaskStates1_3 = spy(new TaskOperatorSubtaskStates());
			...
			TaskOperatorSubtaskStates taskOperatorSubtaskStates2_1 = spy(new TaskOperatorSubtaskStates());
			TaskOperatorSubtaskStates taskOperatorSubtaskStates2_2 = spy(new TaskOperatorSubtaskStates());
			TaskOperatorSubtaskStates taskOperatorSubtaskStates2_3 = spy(new TaskOperatorSubtaskStates());
	...
	public void testCheckpointTimeoutIsolated() {
		try {
			...
			TaskOperatorSubtaskStates taskOperatorSubtaskStates1 = spy(new TaskOperatorSubtaskStates());
			OperatorSubtaskState subtaskState1 = mock(OperatorSubtaskState.class);
	...
	public void testStateCleanupForLateOrUnknownMessages() throws Exception {
		...
		TaskOperatorSubtaskStates taskOperatorSubtaskStatesTrigger = spy(new TaskOperatorSubtaskStates());
		...
		TaskOperatorSubtaskStates unknownSubtaskState = mock(TaskOperatorSubtaskStates.class);
		...
		TaskOperatorSubtaskStates differentJobSubtaskState = mock(TaskOperatorSubtaskStates.class);
		...
		TaskOperatorSubtaskStates triggerSubtaskState = mock(TaskOperatorSubtaskStates.class);
		...
		TaskOperatorSubtaskStates ackSubtaskState = mock(TaskOperatorSubtaskStates.class);
		...
		TaskOperatorSubtaskStates unknownSubtaskState2 = mock(TaskOperatorSubtaskStates.class);
	...
	public void testRestoreLatestCheckpointedState() throws Exception {
		...
		for (int index = 0; index < jobVertex1.getParallelism(); index++) {
			TaskOperatorSubtaskStates subtaskState = mockSubtaskState(jobVertexID1, index, keyGroupPartitions1.get(index));
		...
		for (int index = 0; index < jobVertex2.getParallelism(); index++) {
			TaskOperatorSubtaskStates subtaskState = mockSubtaskState(jobVertexID2, index, keyGroupPartitions2.get(index));
	...
	public void testRestoreLatestCheckpointFailureWhenMaxParallelismChanges() throws Exception {
		...
		for (int index = 0; index < jobVertex1.getParallelism(); index++) {
			...
			TaskOperatorSubtaskStates taskOperatorSubtaskStates = new TaskOperatorSubtaskStates();
	...
	static TaskOperatorSubtaskStates mockSubtaskState(
		JobVertexID jobVertexID,
		int index,
		...
		TaskOperatorSubtaskStates subtaskStates = spy(new TaskOperatorSubtaskStates());
